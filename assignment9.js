...
console.log(data.base_experience, "- base_experience");
console.log(data.height, "- height");
console.log(data.held_items[0].item.url, "- url");
console.log(data.sprites, "- sprites");

let i;
   for(i=0;i<data.stats.length;i++) {
   console.log(data.stats[i].stat.name,"- stat name");
  }

console.log(data.types[0].slot, "-slot");
console.log(data.weight, "- weight");
console.log(data.moves[0].version_group_details[0],"- verison_group_details");
